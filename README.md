...
- Pending highlight rendering uses CSS Highlights when available, and a DOM-wrapper fallback when it is not.
...
- Manual:
  ...
  - Verify pending highlight rendering works on browsers with and without CSS Highlights support.
